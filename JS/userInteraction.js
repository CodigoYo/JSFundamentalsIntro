...
Have you ever seen a dialog box pop-up with a message when you are browsing a website? This was most likely a JavaScript alert message. The syntax for the alert function is as follows:*/
    ...
    // alert("Message goes here.");  UNCOMMENT THIS LINE AND VIEW PAGE IN BROWSER
...
// var confirmed = confirm('Are you sure you want to do XYZ?');//UNCOMMENT THIS LINE AND THE CONSOLE BELOW AND VIEW IN BROWSER CONSOLE
...
//     var userInput = prompt('Please type something:');//UNCOMMENT THIS LINE AND THE ONE BELOW TO VIEW IN BROWSER
